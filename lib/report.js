...
export async function exportPDF(ocs, filtrosTxt) {
  ...
  doc.autoTable({
    ...
    head: [[
      'OC N°', 'N° trámite', 'Procedimiento', 'Secretaría', 'Proveedor', 'Descripción',
...
export async function exportDOCX(ocs, filtrosTxt) {
  ...
  body += th(['OC N°', 'N° trámite', 'Procedimiento', 'Secretaría', 'Proveedor', 'Monto OC', 'Pagado', 'Saldo', '% Av.']);
  ocs.forEach((o) => {
    body += tr([
      o.ocNum, dash(o.tramiteNro), dash(o.procedimiento), o.secretaria, o.proveedor,
      fmtARS(o.ocMonto), fmtARS(o.totalPagado), fmtARS(o.saldo), fmtPct(o.avance),
    ], 5);
  });
  body += '</table>';
