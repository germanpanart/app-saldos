...
import { SECRETARIA_NOMBRE } from '@/lib/format.js';
      ...
      <div className="max-w-[1400px] mx-auto px-5 py-3 flex items-center justify-between gap-4">
        <Link href="/" className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[11px] text-brand-100/80">Compras y Contrataciones · {SECRETARIA_NOMBRE.obras} · {SECRETARIA_NOMBRE.educacion}</p>
          </div>
        </Link>
