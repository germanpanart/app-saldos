-- ============================================================
-- 0002_views.sql — Vistas de saldo (fuente única de verdad)
-- Portan la lógica del saldo del Sheets a SQL, sin celdas combinadas.
-- ============================================================

-- Saldo por trámite: total pagado, saldo, avance y estado_saldo.
create or replace view v_tramite_saldo as
with pagos as (
  select tramite_id,
...
-- Saldo acumulado por cada orden de pago (saldo progresivo / historial).
create or replace view v_orden_pago_saldo as
select
  op.id,
  op.tramite_id,
  op.orden_index,
